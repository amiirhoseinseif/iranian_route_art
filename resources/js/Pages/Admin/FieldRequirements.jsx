        ...
        <FestivalLayout title="مدیریت فیلدهای ثبت اثر">
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                    <h2 className="text-xl font-bold text-gray-800 mb-4 font-['Vazirmatn']">
                        انتخاب رشته هنری
                    </h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {artFields.map((field) => (
                            <button
                                ...
                                className={`p-4 rounded-lg border-2 transition-all font-['Vazirmatn'] ${
                ...
                {selectedArtField && (
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-800 font-['Vazirmatn']">
                                فیلدهای ثبت اثر برای {artFields.find(f => f.id === selectedArtField)?.name}
                            </h2>
                            <PrimaryButton onClick={openAddModal} className="font-['Vazirmatn']">
                                افزودن فیلد جدید
                            </PrimaryButton>
                        </div>

                        {requirements.length === 0 ? (
                            <div className="text-center py-12 text-gray-500 font-['Vazirmatn']">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-2">
                                                    <h3 className="text-lg font-bold text-gray-800 font-['Vazirmatn']">
                                                        {requirement.display_name || requirement.field_name}
                                                    </h3>
                                                    <span className={`px-2 py-1 rounded text-xs font-['Vazirmatn'] ${getRequirementTypeBadge(requirement.requirement_type)}`}>
                                                ...
                                                {requirement.description && (
                                                    <p className="text-gray-600 text-sm mb-2 font-['Vazirmatn']">
                                                        {requirement.description}
                                                    </p>
                                                )}
                                                <div className="text-xs text-gray-500 font-['Vazirmatn']">
                                                    نام فیلد: <code className="bg-gray-100 px-2 py-1 rounded">{requirement.field_name}</code>
                                                    {' • '}
                                                    ترتیب: {requirement.order || 0}
                                                </div>
                                            </div>
                                            <div className="flex gap-2">
                                                <button
                                                    onClick={() => handleEdit(requirement)}
                                                    className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors font-['Vazirmatn']"
                                                >
                                                    ویرایش
                                                </button>
                                                <button
                                                    onClick={() => handleDelete(requirement.id)}
                                                    className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-['Vazirmatn']"
                                                >
                                                    حذف
                                                </button>
                                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <TextInput
                                    ...
                                    className="mt-1 block w-full font-['Vazirmatn']"
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 font-['Vazirmatn']"
                                    required
                                >
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                ...
                                <PrimaryButton disabled={loading} className="font-['Vazirmatn']">
